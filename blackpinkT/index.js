$(document).ready(function () {
  ...
  $(document).on("click", ".show-modal", function (e) {
    ...
    $("#showBox").html(
      '<img style="width:100%" src="' +
        "https://d32irlhdxs9v1a.cloudfront.net" +
        "/qrcodes/" +
        user +
        "/" +
        type +
  ...
  function submit() {
    ...
    $.ajax({
      url: "https://9xtyp7cc06.execute-api.ap-northeast-2.amazonaws.com/dev/conference",
      method: "post",
      datatype: "json",
      data: JSON.stringify({
        type: type,
  ...
  function load_data() {
    $.ajax({
      url: "https://9xtyp7cc06.execute-api.ap-northeast-2.amazonaws.com/dev/conference/users/*",
      method: "get",
      success: function (r) {
        var html = "";
...
//     <a
//       class="show-modal mdl-list__item-secondary-action"
//       href="#"
//     >
